/*
  ...
  - You are about to drop the column `semesterRegistraionId` on the `student_semester_registration_courses` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "student_semester_registration_courses" DROP CONSTRAINT "student_semester_registration_courses_semesterRegistraionI_fkey";

-- AlterTable
ALTER TABLE "student_semester_registration_courses" DROP CONSTRAINT "student_semester_registration_courses_pkey",
DROP COLUMN "semesterRegistraionId",
