...
CREATE TABLE "student_semester_registration_courses" (
    ...
    CONSTRAINT "student_semester_registration_courses_pkey" PRIMARY KEY ("semesterRegistraionId","studentId","offeredCourseId")
);

-- AddForeignKey
ALTER TABLE "student_semester_registration_courses" ADD CONSTRAINT "student_semester_registration_courses_semesterRegistraionI_fkey" FOREIGN KEY ("semesterRegistraionId") REFERENCES "semester_registration"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
